...
var cell_x_with_buff_between_slots = (cell_size + x_buffer_between_slots) * inventory_UI_scale;
var cell_y_with_buff_between_slots = (cell_size + y_buffer_between_slots) * inventory_UI_scale;

var mouse_x_inventory = mouse_x_gui - inventory_quick_slot_x;
var mouse_y_inventory = mouse_y_gui - inventory_quick_slot_y;
...
if(mouse_x_gui >= inventory_quick_slot_x && slot_hover_x < inventory_slots_width && mouse_y_gui >= inventory_quick_slot_y && slot_hover_y < 1){
	...
	if((slot_x < cell_size * inventory_UI_scale) && (slot_y < cell_size * inventory_UI_scale)){
		mouse_x_slot = slot_hover_x;
		mouse_y_slot = slot_hover_y;
	}
	if(slot_hover_x >= 0 && slot_hover_y >= 0){
		hover_slot = min(inventory_slots -1, mouse_x_slot + (mouse_y_slot*inventory_slots_width));
	}else{
		hover_slot = -1;
	}
}else{
